...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      description: "e.g. 'Bukit Peninsula, Bali' — shown in the intro card.",
      group: "overview",
    ...
    defineField({
      ...
      title: "Intro Heading",
      type: "string",
      description: "Heading shown next to the intro card.",
      group: "overview",
      fieldset: "introSection",
    }),
    defineField({
      name: "introHeadingLevel",
      title: "Intro Heading Level",
      type: "string",
      options: {
        list: [
          { title: "H1", value: "h1" },
    ...
    defineField({
      name: "introVideoId",
      title: "Intro Video (Bunny)",
      type: "string",
      description:
        "Optional Bunny Stream video GUID. Shown between the heading and body text.",
      group: "overview",
      fieldset: "introSection",
    }),
    defineField({
      ...
      type: "array",
      of: [{ type: "block" }],
      description: "Rich text shown below the heading on the overview page.",
      group: "overview",
      fieldset: "introSection",
    }),
    defineField({
    ...
    defineField({
      ...
      type: "string",
      description:
        'Short description shown on camp cards, e.g. "Boutique villa steps from Bali\'s most famous barrel"',
      group: "overview",
    }),
    defineField({
      name: "image",
