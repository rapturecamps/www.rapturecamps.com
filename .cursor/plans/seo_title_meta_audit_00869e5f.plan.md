...
| **New (Astro)** | About Us | Rapture Surfcamps                      | Founded in 2003, Rapture Surfcamps has grown into a global network of 8 surf camps across 5 countries.                                                 |
...
| **New (Astro)** | Blog - Waves for Days | Rapture Surfcamps                 | *(uses BaseLayout default -- no custom description set)*                                                                                                   |
...
| **New (Astro)** | Contact Us | Rapture Surfcamps                          | Get in touch with Rapture Surfcamps. Ask questions about our surf camps via email, WhatsApp, Telegram, or our contact form.                       |
...
| **New (Astro)** | Surf Camps Worldwide | Rapture Surfcamps | Choose your surf camp destination. Rapture Surfcamps operates in Bali, Costa Rica, Portugal, Morocco, and Nicaragua. |
...
|                 | Title                                                     | Description                                                                                                                                                |
| --------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Live (WP)**   | Surf Camp Bali -- 20 Years of Surf Lessons | Rapturecamps | Learn to surf in just one week -- Bali's trusted surf camp with 20+ years of experience and 8,000+ happy guests. Lessons, yoga, skate training & massages. |
| **New (Astro)** | Surf Camps in Bali | Rapture Surfcamps                    | *(hardcoded in `[country].astro` -- uses tagline as content, no explicit meta description passed)*                                                         |
...
|                 | Title                                            | Description                                                                                                     |
| --------------- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| **New (Astro)** | Rapture Surf Camp {campName} | Rapture Surfcamps | Experience the best surf camp at {campName}. Daily surf lessons, yoga, delicious food, and unforgettable vibes. |
...
|                 | Title                   | Description                                                                                                             |
| --------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| **New (Astro)** | FAQ | Rapture Surfcamps | Frequently asked questions about Rapture Surfcamps. Find answers about booking, surfing lessons, rooms, food, and more. |
...
|                 | Title                                   | Description                                                                                                                               |
| --------------- | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| **New (Astro)** | Jobs | Work With Us - Rapture Surfcamps | Do you want to work with us? Check surf jobs available at our camps. Browse through our career opportunities and join the Rapture family! |
